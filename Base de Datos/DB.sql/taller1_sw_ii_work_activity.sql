...
--
-- Host: 127.0.0.1    Database: taller1_sw_ii
-- ------------------------------------------------------
...
CREATE TABLE `work_activity` (
  ...
  `idwork_activity` int(11) NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`idwork_activity`)
...
INSERT INTO `work_activity` VALUES ('Angie','Galindo','Estidiante','8',1),('Viviana','Galindo','Estudiante','5',2);
...
-- Dump completed on 2019-09-16 20:09:44
